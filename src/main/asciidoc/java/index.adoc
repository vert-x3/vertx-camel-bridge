...
`link:../../apidocs/io/vertx/ext/camel/CamelBridge.html#start-io.vertx.core.Handler-[start]` to be notified when the bridge has been started.
...
`link:../../apidocs/io/vertx/ext/camel/CamelBridge.html#stop-io.vertx.core.Handler-[stop]` to be notified when the bridge has been stopped.
